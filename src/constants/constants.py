...
SYSTEM_DOWNSAMPLE_FACTOR = 1      # 默认时域显示降采样因子
EFFECTIVE_SAMPLE_RATE = ORIGINAL_SAMPLE_RATE / SYSTEM_DOWNSAMPLE_FACTOR

# 时域显示专用降采样
TIME_DISPLAY_DOWNSAMPLE = 1
TIME_DISPLAY_SAMPLE_RATE = EFFECTIVE_SAMPLE_RATE / TIME_DISPLAY_DOWNSAMPLE
...
# 性能相关配置
MAX_TIME_DISPLAY_POINTS = 100000    # 时域最大显示点数
MAX_PSD_SAMPLES = 50000             # PSD Welch 单段最大样本数
TIME_BUFFER_MAX_POINTS = 1000000    # 时域缓冲区最大点数（1.0秒@1MHz）
